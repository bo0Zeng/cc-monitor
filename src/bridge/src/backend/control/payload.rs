...
mod tests {
    ...
    fn the_refuse_tag_is_the_same_string_on_both_sides() {
        const RUNNER: &str = include_str!("../../../../remote-launch-run.ts");
    ...
    fn container_path_source() -> String {
        let p = crate::guard_support::repo_root().join("src/backend/control/ccm/plan.rs");
    ...
    fn the_population_that_renders_env_prefixes_for_the_agent_process_is_enumerated() {
        ...
        let sites = [
            ...
            Site {
                ...
                src: include_str!("../../../../shell-quote.ts"),
