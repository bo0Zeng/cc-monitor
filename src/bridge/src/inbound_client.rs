...
mod tests {
    ...
    fn the_local_origin_is_the_same_string_on_both_sides() {
        let ts = include_str!("../../daemon-policy.ts");
        let line = ts
            .lines()
    ...
    fn the_e2e_command_list_matches_the_daemon_command_table() {
        const SUITE: &str = include_str!("../../../tests/e2e/inbound-daemon-frames.sh");
        const DAEMON_INBOUND: &str = include_str!("../../backend/inbound.rs");
    ...
    fn launch_args_field_names_match_the_daemon_parser() {
        const DAEMON_LAUNCH: &str = include_str!("../../backend/control/launch.rs");
