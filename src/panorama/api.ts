...
export const addAnnotation = (
  ...
  body: string,
  author: string,
) => commands.panorama_add_annotation({ repo, file, symbol, body, author });
...
) => commands.panorama_touching({ repo, files, ranges });
