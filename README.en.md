...
> Details in `src/doc/ARCHITECTURE.md`.
...
- Deployment: [src/doc/REMOTE-PHASE0-DEPLOY.md](src/doc/REMOTE-PHASE0-DEPLOY.md) (auto-deploy + manual fallback)
...
|---|---|---|
| [src/doc/ARCHITECTURE.md](src/doc/ARCHITECTURE.md) | New contributors | Data flow + module map + design layering |
| [src/doc/IPC-PROTOCOL.md](src/doc/IPC-PROTOCOL.md) | Protocol changers | Cross-process file IPC + sessions/status + remote wire schemas + handshake timing |
| [src/doc/REMOTE-PHASE0-DEPLOY.md](src/doc/REMOTE-PHASE0-DEPLOY.md) | Remote deployers | SSH remote backend auto-deploy (#29) + manual deploy runbook (issue #15) |
| [src/doc/INVARIANTS.md](src/doc/INVARIANTS.md) | Everyone | Global invariants (zero intrusion / encoding / ACL / ordering) |
| [src/doc/CONTRIBUTING.md](src/doc/CONTRIBUTING.md) | Contributors | Checklists + cookbook (add IPC / jsonl type / setting / hotkey) |
| [src/doc/DEVELOPMENT.md](src/doc/DEVELOPMENT.md) | Developers | Dev environment + port conflict / debugging |
| [src/doc/BUILDING.md](src/doc/BUILDING.md) | Releasers | Production build + packaging + Code Signing |
| [src/doc/RELEASING.md](src/doc/RELEASING.md) | Releasers | Release SOP + how to write the CHANGELOG |
