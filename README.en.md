...
| [doc/REMOTE-PHASE0-DEPLOY.md](doc/REMOTE-PHASE0-DEPLOY.md) | Remote deployers | SSH remote backend auto-deploy (#29) + manual deploy runbook (issue #15) |
