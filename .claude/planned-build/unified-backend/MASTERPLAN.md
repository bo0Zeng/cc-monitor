...
| **U8c-3** | 删 TS 两个渲染器 + IR，收敛 §33/§35/§36/§37/§38/§39，**重指 S19 第五处** | ⚠ 删 `session-backend.ts` 前必须先回答三件事（§33b 写死）：① 生产切到 daemon `launch` 没有；② **attach 那条串归谁产**；③ **daemonless 的远端**（U12 未决）还要不要能起会话。牵 E24 |
