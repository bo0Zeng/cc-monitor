...
- **当前功能**：**U6b-1（入方向骨架）Phase C**。U6a 已闭环提交 `6b06ec0`；U6b 拆成 U6b-1/2/3（见变更记录）。
...
| **U6b-1** 入方向骨架 | 🔵 Phase B 完成，进 C | — |
| U1b · U4b · U6b-2/3 · U7–U15 | 待做 | — |
...
### 当前门禁基线（U6a Phase C 后实测）

daemon `cargo test` **202**（U6a 前 200，+2 = 本轮两条对拍护栏）· monitor `--lib` **666 / 3 ignored**
（含本轮 3 条握手护栏）· `npm test` **80 文件 1154 例** · `tsc` 0 · 两侧 `cargo fmt` OK ·
clippy monitor 64 条 **与 HEAD 逐条相同（零新增）**、daemon 0 · 均 RC=0。
