...
- **当前功能**：U7-1..U7-5 已闭环。**§0.1 分类 ③ 已判定**（见变更记录）：两处性质不同、都不按合流排 —— U7d 是「本机读面在 Linux/macOS 上整体不工作」，U7b 是「旧轮询路径退役了没有」。下一个：**U7b（tmux 旧轮询退役，先查它还跑不跑）**。
...
| U1b · U4b · **U7b**（tmux 旧轮询退役）· **U7d**（本机读面在 Linux/macOS 不工作）· U8–U15 | 待做 | — |
