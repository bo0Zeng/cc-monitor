...
- **当前功能**：U7-1 / U7-2 / U7-3 已闭环 ⇒ **§0.1 分类 ②「真该合的」两项全部合完**。下一个：**U7-4 补 `local_accounts.rs` 的测试覆盖**（U7-3 登记的空白），然后 §0.1 分类 ③（判活 / tmux，是「写新实现」不是删重复）。
...
| U1b · U4b · **U7-4**（补 local_accounts 覆盖）· U7b/d · U8–U15 | 待做 | — |
