...
- **阻塞 / 待用户确认**：
  ...
  - **[新，硬前置] G-B 未做**：`vendor/cc-acct-iso/scripts/` 1348 行 bash 还在 shellcheck 门禁外、
    它自己 424 行测试从没跑过。gate-integrity 主计划定的「没有网不能改那个工具」——
    而 Z06/Z08 是对它的**结构性**改动，比 Z01 大得多。**G-B 无外部阻塞，可直接做。**
