 ...
 *
 * 跑法：`node tests/views/history-cache.test.ts` 或 `npm run test:history-cache`。
...
import { shouldRefetchRemote, HISTORY_REMOTE_TTL_MS } from "../../src/views/history-cache.ts";
