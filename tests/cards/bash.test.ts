 ...
 *
 * 跑法：`node tests/cards/bash.test.ts` 或 `npm run test:bash`。
...
import { parseBashInput, parseBashOutput, unescapeEntities } from "../../src/cards/bash.ts";
import { parseSlashCommand } from "../../src/cards/slash.ts";
